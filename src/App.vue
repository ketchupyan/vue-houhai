<template>
  <div id="app">
    <header class="header headerFixed">
      <el-row>
        <el-col :span="24">
          <el-menu class="el-menu-demo" mode="horizontal" default-active="5">
    ...
    <main>
      <div class="main-left">
        <el-menu :router="true" default-active="/activePublic" class="el-menu-vertical-demo">
          <el-menu-item :class="{'isActive':active}" index="/activePublic">活动发布</el-menu-item>
          <el-menu-item :class="{'isActive':!active}" index="/activeManage">活动管理</el-menu-item>
        </el-menu>
      </div>
